...
export const DEFAULT_GARMENTS: Garment[] = [
  ...
  {
    id: "navy-ruffle-dress",
    name: "Navy Ruffle Dress",
    price: 0,
    currency: "USD",
    material: "Navy woven; sleeveless with ruffled shoulder detail, cowl neckline",
    care: "Hand wash or gentle cycle. Hang to dry.",
    type: "Dress",
    category: "one-time-scenario",
    categoryLabel: GARMENT_CATEGORIES["one-time-scenario"].label,
    purchaseTension: GARMENT_CATEGORIES["one-time-scenario"].tension,
    imageUrl: "/garments/navy-ruffle-dress.jpg",
    roastLines: [
      "A ruffle dress is a costume looking for an invitation.",
      "Navy reads serious. The ruffles disagree.",
    ],
    isDefault: true,
  },
  {
  ...
  {
    id: "pink-illustrated-print-romper",
    name: "Pink Illustrated Print Romper",
    price: 0,
    currency: "USD",
    material: "Pink woven with bold illustrated floral + animal print; 3/4 sleeve, deep V-neck",
    care: "Machine wash cold inside out. Hang to dry.",
    type: "Dress",
    category: "unclear-occasion",
    categoryLabel: GARMENT_CATEGORIES["unclear-occasion"].label,
    purchaseTension: GARMENT_CATEGORIES["unclear-occasion"].tension,
    imageUrl: "/garments/pink-illustrated-print-romper.jpg",
    roastLines: [
      "An illustrated print is a statement. The statement is usually 'look at me'.",
      "A romper for an event you cannot name is just very committed loungewear.",
    ],
    isDefault: true,
  },
];
